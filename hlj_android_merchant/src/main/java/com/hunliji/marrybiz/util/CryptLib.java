 ...
 * Code sample
 */
//        String masterPassword = "p4ssw0rd";
//        String originalText = "top secret message";
//
//        try {
//            CryptLib _crypt = new CryptLib();
//            String output = "";
//            String plainText = originalText;
//            //            String key = CryptLib.SHA256(masterPassword, 32); //32 bytes = 256 bit
...
//            output = _crypt.decrypt(output, key, ""); //decrypt
...
public class CryptLib {
    ...
    public CryptLib() throws NoSuchAlgorithmException, NoSuchPaddingException {
        ...
        _cx = Cipher.getInstance("AES/CBC/NoPadding");
    ...
    private String encryptDecrypt(String _inputText, String _encryptionKey, EncryptMode _mode,
                                  String _initVector) throws UnsupportedEncodingException,
        ...
        // 自己实现简易个 padding 数据
        byte[] dataBytes = _encryptionKey.getBytes();
        int plaintextLength = dataBytes.length;
        int blockSize = _cx.getBlockSize();
    ...
    public String encrypt(String _plainText, String _key, String _iv) throws InvalidKeyException,
    ...
    public String decrypt(String _encryptedText, String _key,
                          String _iv) throws InvalidKeyException, UnsupportedEncodingException,
