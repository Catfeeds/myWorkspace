...
public class RoundProgressDialog extends Dialog {
    ...
    public void onComplate() {
        ...
        ObjectAnimator scaleAnimationX = ObjectAnimator.ofFloat(complateView,
                "scaleX", 2f);
        ObjectAnimator scaleAnimationY = ObjectAnimator.ofFloat(complateView,
                "scaleY", 2f);
        animatorSet.play(scaleAnimationX).with(scaleAnimationY);
