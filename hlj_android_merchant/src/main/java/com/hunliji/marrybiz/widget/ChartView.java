...
import com.hunliji.marrybiz.adapter.LabelAdapter;
import com.hunliji.marrybiz.util.AbstractSeries;
...
public class ChartView extends RelativeLayout {
    ...
    public ChartView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mShadowColor = attributes.getInt(R.styleable.ChartView_shadowColor, Color.TRANSPARENT);
        ...
        mRightLabelWidth = attributes.getDimensionPixelSize(R.styleable
                .ChartView_rightLabelWidth, 0);
        mBottomLabelHeight = attributes.getDimensionPixelSize(R.styleable
                .ChartView_bottomLabelHeight, 0);
        ...
        mTopLabelLayout.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT,
                mTopLabelHeight));
        ...
        // bottom label layout
        LayoutParams bottomLabelParams = new LayoutParams(LayoutParams.MATCH_PARENT,
                mBottomLabelHeight);
    ...
    private void drawGrid(Canvas canvas) {
        ...
        for (int i = 0; i < mGridLinesVertical + 2; i++) {
            Path mPath = new Path();
            mPath.moveTo(left, top + (stepY * i));
            mPath.lineTo(right, top + (stepY * i));
