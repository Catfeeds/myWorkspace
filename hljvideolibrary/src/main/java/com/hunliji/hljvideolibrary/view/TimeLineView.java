...
public class TimeLineView extends View {
    ...
    public static final int TIME_LINE_VIEW_HEIGHT_DP = 50;
    ...
    private void init() {
        mHeightView = CommonUtil.dp2px(getContext(), TIME_LINE_VIEW_HEIGHT_DP);
    }
        ...
        BackgroundExecutor.execute(new BackgroundExecutor.Task("", 0L, "") {
            ...
            public void execute() {
                try {
                    ...
                    // Retrieve media data
                    long videoLengthInMs = Integer.parseInt(mediaMetadataRetriever.extractMetadata(
                    ...
                    for (int i = 0; i < numThumbs; ++i) {
                        ...
                        // bitmap might be null here, hence throwing NullPointerException.
                        // You were right
                        try {
