...
public class RangeSeekBarView extends View {
    ...
    private void init() {
        ...
        mScaleRangeMax = 100;
        mHeightTimeLine = CommonUtil.dp2px(getContext(), TimeLineView.TIME_LINE_VIEW_HEIGHT_DP);
        ...
        int shadowColor = Color.parseColor("#A6000000");
    ...
    public boolean onTouchEvent(@NonNull MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (currentThumb == 0) {
                    if ((newX + mThumb.getWidthBitmap()) >= mThumb2.getPos() - mPixelMinLength) {
    ...
    private void checkPositionThumb(
            @NonNull Thumb mThumbLeft, @NonNull Thumb mThumbRight, float dx, boolean isLeftMove) {
        if (isLeftMove && dx < 0) {
