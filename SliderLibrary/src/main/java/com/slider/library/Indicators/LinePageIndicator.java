...
public class LinePageIndicator extends View implements PageIndicator {
    ...
    public LinePageIndicator(
        ...
        final float defaultLineWidth = res.getDimension(R.dimen
                .default_line_indicator_line_width);
        final float defaultGapWidth = res.getDimension(R.dimen
        ...
        final boolean defaultCentered = res.getBoolean(R.bool
        ...
        mPaintUnselected.setColor(a.getColor(R.styleable
                .LinePageIndicator_unselectedColor,
                defaultUnselectedColor));
        mPaintSelected.setColor(a.getColor(R.styleable
                .LinePageIndicator_selectedColor,
                defaultSelectedColor));

        mPaintSelected.setStrokeWidth(a.getDimension(R.styleable
                .LinePageIndicator_lineHeight,
        ...
        Drawable background = a.getDrawable(R.styleable
                .LinePageIndicator_android_background);
        if (background != null) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mCentered) {
            horizontalOffset += ((getWidth() - paddingLeft - paddingRight) /
                    2.0f) - (indicatorWidth / 2.0f);
        }
            ...
            case MotionEvent.ACTION_UP:
                if (!mIsDragging) {
                    ...
                    if ((mCurrentPage > 0) && (ev.getX() < halfWidth -
                        ...
                        return true;
                    } else if ((mCurrentPage < count - 1) && (ev.getX() >
    ...
    private int measureWidth(int measureSpec) {
        ...
        if ((specMode == MeasureSpec.EXACTLY) || (mViewPager == null)) {
            ...
            final int count = mViewPager.getAdapter()
                    .getCount();
            result = getPaddingLeft() + getPaddingRight() + (count *
                    mLineWidth) + ((count - 1) * mGapWidth);
