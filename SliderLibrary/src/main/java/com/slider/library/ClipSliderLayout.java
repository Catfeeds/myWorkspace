...
import com.slider.library.Transformers.ClipTransformer;
...
public class ClipSliderLayout extends RelativeLayout {
    ...
    public ClipSliderLayout(Context context) {
        this(context, null);
    }

    public ClipSliderLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ClipSliderLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        removeAllViewsInLayout();
        mContext = context;
        LayoutInflater.from(context)
                .inflate(R.layout.clip_slider_layout, this, true);
        ...
        mIsWrapContentHeight = attributes.getBoolean(R.styleable
                        .SliderLayout_is_height_wrap_content,
                false);
    ...
    public enum Transformer {
        Default("Default"), Accordion("Accordion"), Background2Foreground
                ("Background2Foreground"), CubeIn(
                "CubeIn"), DepthPage("DepthPage"), Fade("Fade"), FlipHorizontal("FlipHorizontal")
        , FlipPage(
                ...
                "ZoomOutSlide"), ZoomOut("ZoomOut"), Clip("Clip");
