...
public class HtmlUtils {
    public static String getHtmlFromFile(Activity activity, String filename) {
        try {
            ...
            Log.e("HtmlUtils", "Unable to load editor HTML (is the assets symlink working?): " + e.getMessage());
            return null;
        }
    }
    ...
    public static String decodeHtml(String html) {
        if (html != null) {
            try {
                ...
                Log.e("HtmlUtils", "Unsupported encoding exception while decoding HTML.");
            }
        }
        return html;
    }
    ...
    public static String getFileSrcToPath(String fileSrc){
        return fileSrc.replace("file://","");
    }
}
