...
/**
 * Created by mo_yu on 2016/1/3.本周热门问题
 */
public class WeekQuestionsFragment extends ScrollAbleFragment implements PullToRefreshBase
        .OnRefreshListener {
    ...
    public static WeekQuestionsFragment newInstance() {
        Bundle args = new Bundle();
        WeekQuestionsFragment fragment = new WeekQuestionsFragment();
    ...
    public void refresh(Object... params) {
        if (refreshSubscriber == null || refreshSubscriber.isUnsubscribed()) {
            ...
            QuestionAnswerApi.getWeekQuestionsObb(1)
        ...
        Observable<HljHttpData<List<Question>>> observable = PaginationTool.buildPagingObservable(
                ...
                new PagingListener<HljHttpData<List<Question>>>() {
                    ...
                    public Observable<HljHttpData<List<Question>>> onNextPage(int page) {
                        return QuestionAnswerApi.getWeekQuestionsObb(page);
                    }
                })
                .setEndView(endView)
