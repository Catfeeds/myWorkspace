...
import com.hunliji.hljcommonviewlibrary.adapters.viewholders.CommonQuestionViewHolder;
...
public class QuestionAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public QuestionAdapter(
            Context context, ArrayList<Question> data) {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            ...
            default:
                CommonQuestionViewHolder holder = new CommonQuestionViewHolder(LayoutInflater.from(
                        parent.getContext())
    ...
    public void onBindViewHolder(BaseViewHolder holder, int position) {
        if (holder instanceof CommonQuestionViewHolder) {
