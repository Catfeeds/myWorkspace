...
/**
 * Created by mo_yu on 2017/12/26.精选车队
 */

public class WeddingCarHotFragment extends ScrollAbleFragment implements
    ...
    public static WeddingCarHotFragment newInstance(long cityId) {
        Bundle args = new Bundle();
        WeddingCarHotFragment fragment = new WeddingCarHotFragment();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        adapter = new WeddingCarHotRecyclerAdapter(getContext());
    ...
    private void initTracker() {
        HljVTTagger.tagViewParentName(recyclerView,
                HljTaggerName.WeddingCarSubPageActivity.CAR_MEAL_LIST);
    }
    ...
    private void initLoad() {
        if (initSubscriber == null || initSubscriber.isUnsubscribed()) {
            initSubscriber = HljHttpSubscriber.buildSubscriber(getContext())
                    ...
                    .setProgressBar(progressBar.getVisibility() == View.VISIBLE ? progressBar :
                            null)
                    ...
                    .setOnNextListener(new SubscriberOnNextListener<HljHttpData<List<WeddingCarProduct>>>() {
                        ...
                        public void onNext(
                            ...
                            WeddingCarSubPageActivity activity = (WeddingCarSubPageActivity)
                                    getActivity();
                            if (activity != null) {
                                activity.setHotCount(listHljHttpData.getTotalCount());
                            }
                    ...
                    .build();
            WeddingCarApi.getHotCarMeals(getUrl(1))
    ...
    private void initPagination(int pageCount) {
        ...
        pageSubscriber = PaginationTool.buildPagingObservable(recyclerView.getRefreshableView(),
                pageCount,
                new PagingListener<HljHttpData<List<WeddingCarProduct>>>() {
                    ...
                    public Observable<HljHttpData<List<WeddingCarProduct>>> onNextPage(int page) {
                        return WeddingCarApi.getHotCarMeals(getUrl(page));
                    }
                })
                .setEndView(endView)
    ...
    private String getUrl(int page) {
        StringBuilder url = new StringBuilder("p/wedding/index" + "" + "" + "" + "" + "" + "" +
                "" + ".php/Car/APICarProduct/CarProductMeal");
        url.append("?page=")
                .append(page)
                .append("&per_page=20")
                .append("&cid=")
    ...
    public void onDestroyView() {
        super.onDestroyView();
        unbinder.unbind();
        CommonUtil.unSubscribeSubs(initSubscriber, pageSubscriber);
    ...
    public void onItemClick(
            int position, WeddingCarProduct weddingCarProduct) {
