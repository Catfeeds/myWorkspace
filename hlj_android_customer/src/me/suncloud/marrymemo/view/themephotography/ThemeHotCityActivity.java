 ...
 */
public class ThemeHotCityActivity extends HljBaseNoBarActivity {
    ...
    private void initTracker() {
        HljVTTagger.tagViewParentName(recyclerView, "hot_cities_list");
    }

    private void initWidget() {
        adapter = new ThemeAdapter(this, Constants.THEME_TYPE.HOTCITY);
                    ...
                    public void onScrolled(
                        ...
                        switch (viewType) {
                            case Constants.JOURNEY_TYPE.DESTINATION:
                                ...
                                tvAllInfo.setVisibility(View.INVISIBLE);
    ...
    private void initData() {
        String url = Constants.getAbsUrl(Constants.HttpPath.GET_JOURNEY_THEME) + "?id=1";
