...
import me.suncloud.marrymemo.fragment.work_case.WeddingMakeupWorkListFragment;

/**
 * 婚礼跟妆频道页首页
 * Created by chen_bin on 2017/7/28 0028.
 */
public class WeddingMakeupChannelActivity extends BaseMerchantServiceChannelActivity {
    ...
    public long getPropertyId() {
        return Merchant.PROPERTY_WEDDING_MAKEUP;
    }

    @Override
    public ScrollAbleFragment getFragment(int position) {
        return WeddingMakeupWorkListFragment.newInstance(getPropertyId(),
