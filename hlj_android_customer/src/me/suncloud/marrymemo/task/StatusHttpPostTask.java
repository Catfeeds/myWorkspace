 ...
 */
public class StatusHttpPostTask extends AsyncTask<String, Long, JSONObject> {

    protected Context context;
    protected StatusRequestListener requestListener;
    protected RoundProgressDialog roundProgressDialog;

    public StatusHttpPostTask(Context context, StatusRequestListener requestListener) {
        super();
        this.context = context;
        this.requestListener = requestListener;
    }

    public StatusHttpPostTask(
            Context context,
    ...
    protected JSONObject doInBackground(String... params) {
        ...
        try {
            ...
            jsonStr = JSONUtil.postJsonWithAttach(url, objectString, progressListener);
