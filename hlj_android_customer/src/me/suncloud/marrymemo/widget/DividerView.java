...
/**
 * Created by Suncloud on 2016/4/16.
 */
public class DividerView extends View {
    ...
    public DividerView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            color = a.getColor(R.styleable.DividerView_d_color, 0xff000000);
            orientation = a.getInt(R.styleable.DividerView_d_orientation, ORIENTATION_HORIZONTAL);
        } finally {
            a.recycle();
        }
