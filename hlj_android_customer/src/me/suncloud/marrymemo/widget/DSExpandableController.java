 ...
 */
public class DSExpandableController extends SimpleFloatExpandableViewManager implements View.OnTouchListener, GestureDetector.OnGestureListener {
    ...
    private DSExpandableListView mDslv;
     ...
     */
    public DSExpandableController(DSExpandableListView dslv) {
        this(dslv, 0, ON_DOWN, FLING_REMOVE);
    }

    public DSExpandableController(DSExpandableListView dslv, int dragHandleId, int dragInitMode,
                                  int removeMode) {
    ...
    public boolean startDrag(int position, int deltaX, int deltaY) {
        ...
        if (mSortEnabled && !mIsRemoving) {
            dragFlags |= DSExpandableListView.DRAG_POS_Y | DSExpandableListView.DRAG_NEG_Y;
        }
        if (mRemoveEnabled && mIsRemoving) {
            dragFlags |= DSExpandableListView.DRAG_POS_X;
            dragFlags |= DSExpandableListView.DRAG_NEG_X;
        }
