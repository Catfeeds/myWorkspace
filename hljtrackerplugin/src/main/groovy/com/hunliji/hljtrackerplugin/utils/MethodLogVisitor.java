...
//        Log.logEach("visitMethodInsn", owner, name, desc, itf);
...
//        Log.logEach("visitFieldInsn", owner, name, desc);
...
//        Log.logEach("visitVarInsn", var);
//        super.visitVarInsn(opcode, var);
//    }
//
//    @Override
//    public void visitJumpInsn(int opcode, Label label) {
//        Log.logEach("visitJumpInsn", label);
