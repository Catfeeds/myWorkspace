...
public class WebSocketRailsDispatcher {
    ...
    public WebSocketRailsDispatcher(URL url, Map<String, String> heards) {
        this.url = url;
        state = "connecting";
        ...
        connection = new WebSocketRailsConnection(url, this, heards);
        connectionId = "";
    }
    ...
    public boolean isconnect() {
        return connection.isconnect() && !state.equals("disconnected");
    }
