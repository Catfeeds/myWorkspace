...
public enum GiftUtil {
    ...
    public static final Class[] ACTIVITIES_ALLOW_DLG = {MainActivity.class,
            ReceiveGiftCashActivity.class};
    ...
    private HljBaseActivity checkAndGetActivity() {
        Activity activity = HljCardMasterLiveCycleImpl.getInstance()
                .getCurrentActivity();
        if (activity != null) {
