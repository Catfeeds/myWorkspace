...
public class LLPaySecurePayer {
     ...
     * @return
     */
    public boolean pay(String strOrderInfo, final Handler callback, final int myWhat, final
    Activity activity, boolean isTest) {
     ...
     */
    public boolean pay(String strOrderInfo, final Handler callback, final int myWhat, final
    Activity activity, boolean signCard, boolean isTest) {
        if (mbPaying)
            return false;
        mbPaying = true;
        ...
        if (payService == null) {
            ...
            // 解绑时同理
            mActivity.getApplicationContext().bindService(new Intent(activity, PayService.class),
    ...
    private IRemoteServiceCallback mCallback = new IRemoteServiceCallback.Stub() {
         ...
         */
        public void startActivity(String packageName, String className, int iCallingPid, Bundle
