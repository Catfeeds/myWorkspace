...
public class WheelView extends View {
    ...
    private int centerRectOffset = 0;
	...
	private void drawCenterRect(Canvas canvas) {
        ...
        centerDrawable.setBounds(0, center - offset + centerRectOffset, getWidth(), center + offset + centerRectOffset);

        centerDrawable.draw(canvas);
	}

    public void setCenterRectOffset(int offset) {
        this.centerRectOffset = offset;
    }
