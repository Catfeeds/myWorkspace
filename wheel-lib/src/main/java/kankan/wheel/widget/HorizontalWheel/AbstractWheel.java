...
public abstract class AbstractWheel extends View {
    ...
    // Listeners
    private List<AbsOnWheelChangedListener> changingListeners = new LinkedList<AbsOnWheelChangedListener>();
    private List<AbsOnWheelScrollListener> scrollingListeners = new LinkedList<AbsOnWheelScrollListener>();
    private List<AbsOnWheelClickedListener> clickingListeners = new LinkedList<AbsOnWheelClickedListener>();
     ...
     */
    public void addChangingListener(AbsOnWheelChangedListener listener) {
     ...
     * @param listener the listener
     */
    public void removeChangingListener(AbsOnWheelChangedListener listener) {
    ...
    protected void notifyChangingListeners(int oldValue, int newValue) {
        for (AbsOnWheelChangedListener listener : changingListeners) {
     ...
     * @param listener the listener
     */
    public void addScrollingListener(AbsOnWheelScrollListener listener) {
     ...
     * @param listener the listener
     */
    public void removeScrollingListener(AbsOnWheelScrollListener listener) {
    ...
    protected void notifyScrollingListenersAboutStart() {
        for (AbsOnWheelScrollListener listener : scrollingListeners) {
     ...
     * @param listener the listener
     */
    public void addClickingListener(AbsOnWheelClickedListener listener) {
     ...
     * @param listener the listener
     */
    public void removeClickingListener(AbsOnWheelClickedListener listener) {
    ...
    protected void notifyClickListenersAboutClick(int item) {
        for (AbsOnWheelClickedListener listener : clickingListeners) {
