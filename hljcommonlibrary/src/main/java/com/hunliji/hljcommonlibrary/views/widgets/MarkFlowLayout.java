...
/**
 * 问答标签显示的流布局，显示指定行数，返回显示的数目
 */
public class MarkFlowLayout extends ViewGroup {
    public int mHorizontalSpacing;
    public int mVerticalSpacing;
    private Paint mPaint;
    private int totalCount;
    private int maxLineCount;//最大行数
    private OnMeasuredListener onMeasuredListener;

    public MarkFlowLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
