...
package com.hunliji.hljcommonlibrary.views.widgets.cardview;
...
public class CardView extends FrameLayout {
    ...
    private void initialize(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (a.hasValue(R.styleable.CardView_cardBackgroundColor)) {
            ...
            backgroundColor = ColorStateList.valueOf(hsv[2] > 0.5f ? getResources().getColor(R
                    .color.cardview_light_background) : getResources().getColor(
        ...
        int shadowStartColor = a.getColor(R.styleable.CardView_cardShadowStartColor,
                ContextCompat.getColor(context, R.color.cardview_shadow_start_color));
        int shadowEndColor = a.getColor(R.styleable.CardView_cardShadowEndColor,
                ContextCompat.getColor(context, R.color.cardview_shadow_end_color));
        a.recycle();
        IMPL.initialize(mCardViewDelegate,
                context,
                backgroundColor,
                shadowStartColor,
                shadowEndColor,
    ...
    private final CardViewDelegate mCardViewDelegate = new CardViewDelegate() {
        ...
        public void setShadowPadding(int left, int top, int right, int bottom) {
            ...
            CardView.super.setPadding(left + mContentPadding.left,
