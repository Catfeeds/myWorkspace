...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    * */
    ...
    private void setShadowSize(float shadowSize, float maxShadowSize) {
        if (shadowSize < 0f) {
            throw new IllegalArgumentException("Invalid shadow size " + shadowSize + ". Must be " +
                    ">= 0");
        }
        if (maxShadowSize < 0f) {
    ...
    private void buildShadowCorners() {
        ...
        mCornerShadowPaint.setShader(new RadialGradient(0,
                0,
                mCornerRadius + mShadowSize,
        ...
        mEdgeShadowPaint.setShader(new LinearGradient(0,
                -mCornerRadius + mShadowSize,
                0,
                -mCornerRadius - mShadowSize,
                new int[]{mShadowStartColor, mShadowStartColor, mShadowEndColor},
