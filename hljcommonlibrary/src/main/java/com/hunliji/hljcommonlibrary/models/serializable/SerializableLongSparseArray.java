package com.hunliji.hljcommonlibrary.models.serializable;
...
/**
 * Serializable的LongSparseArray
 * Created by jinxin on 2017/10/24 0024.
 */
...
public class SerializableLongSparseArray<E> extends LongSparseArray<E> implements Serializable {
    ...
    public SerializableLongSparseArray(int initialCapacity) {
    ...
    private void writeObject(ObjectOutputStream oos) {
        try {
            ...
            Log.e(this.getClass()
                    .getSimpleName(), "SerializableLongSparseArray writeObject exception");
            e.printStackTrace();
        }
    }
