package com.hunliji.hljcommonlibrary.animators;
...
public abstract class BaseItemAnimator extends SimpleItemAnimator {
    ...
    public boolean isRunning() {
        return (!mPendingAdditions.isEmpty() || !mPendingChanges.isEmpty() || !mPendingMoves
                .isEmpty() || !mPendingRemovals.isEmpty() || !mMoveAnimations.isEmpty() ||
                !mRemoveAnimations.isEmpty() || !mAddAnimations.isEmpty() || !mChangeAnimations
                .isEmpty() || !mMovesList.isEmpty() || !mAdditionsList.isEmpty() || !mChangesList
                .isEmpty());
    }
    ...
    public boolean canReuseUpdatedViewHolder(
            @NonNull ViewHolder viewHolder, @NonNull List<Object> payloads) {
        return !payloads.isEmpty() || super.canReuseUpdatedViewHolder(viewHolder, payloads);
    }

    protected abstract void preAnimateAddImpl(ViewHolder holder);

    protected abstract void animateAddImpl(ViewHolder holder);

    protected class DefaultAddVpaListener extends AnimatorListenerAdapter {
