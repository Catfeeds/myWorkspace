...
public class HLJCalendarView extends FrameLayout {
    ...
    // 品牌推广的样式资源
    private Bitmap selectedSrcBitmap;
    private Bitmap cropBitmap;
    private String selectedTxtColorStr;
    private String selectedLunarTxtColorStr;
    ...
    private OnDatePickerChangeListener mOnDatePickChangeListener;
    ...
    public HLJCalendarView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HLJCalendarView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setSelectedBgPath(String selectedBgPath) {
        if (TextUtils.isEmpty(selectedBgPath)) {
            selectedSrcBitmap = null;
            cropBitmap = null;
            return;
        }
        if (selectedSrcBitmap != null) {
            return;
        }
        Glide.with(this)
                .asBitmap()
                ...
                .into(new SimpleTarget<Bitmap>() {
                    ...
                    public void onResourceReady(
                        ...
                        selectedSrcBitmap = resource;
                        if (cellHeight != 0 && cellWidth != 0) {
                            cropBitmap = BitmapUtil.centerCrop(selectedSrcBitmap,
                                    cellWidth,
                                    cellHeight);
                        }
                        invalidateTheCurrentMonthView();
                    }
                });
    }

    public void setSelectedTxtColorStr(String selectedTxtColorStr) {
        this.selectedTxtColorStr = selectedTxtColorStr;
    }

    public void setSelectedLunarTxtColorStr(String selectedLunarTxtColorStr) {
        this.selectedLunarTxtColorStr = selectedLunarTxtColorStr;
    }

    public HLJCalendarView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void init(
        ...
        layoutInflater.inflate(R.layout.framelayout_hlj_calendar, this, true);
        mViewPager = findViewById(R.id.viewpager);
        mWeekTitle = findViewById(R.id.week_title);
    ...
    private void setUpWeekTitle(Context context, int firstDayOfWeek) {
        ...
        mWeekTitle.setAdapter(new WeekTitleAdapter(context,
                titles,
                firstDayOfWeek,
    ...
    public void setSelectedDay(int selectedDay) {
        if (mCurrentMonthView != null) {
            mCurrentMonthView.setSelectedDay(selectedDay);
        }
    }
    ...
    private int getCurrentHeight() {
        return mCurrentMonthView.getMeasuredHeight() + getPaddingTop() + getPaddingBottom() +
                mWeekTitle.getMeasuredHeight();
    }
     ...
     * @param context
     */
    public void showDatePicker(Context context, DateTime date) {
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if (mOnDatePickChangeListener != null) {
                    mOnDatePickChangeListener.onDatePickerChangeListener(calendar);
                }
    ...
    private class MonthView extends View {
                    ...
                    if (!dayStr.equals("-1")) {
                        ...
                        if (isShadow) {
                            ...
                            if (mSelectStyle) {
                                if (mHasSelectedDay && dayStr.equals(String.valueOf(mSelectedDay)
                                    ...
                                    if (!TextUtils.isEmpty(selectedTxtColorStr)) {
                                        mMonthNumDrawPaint.setColor(Color.parseColor(
                                                selectedTxtColorStr));
                                    } else {
                                        mMonthNumDrawPaint.setColor(Color.WHITE);
                                    }
                        ...
                        if (mShowLunarDay) {
                            ...
                            if (isShadow) {
                                ...
                                if (mSelectStyle && mHasSelectedDay && dayStr.equals(String.valueOf(
                                        mSelectedDay))) {
                                    if (!TextUtils.isEmpty(selectedLunarTxtColorStr)) {
                                        mMonthNumDrawPaint.setColor(Color.parseColor(
                                                selectedLunarTxtColorStr));
                                    } else {
                                        mMonthNumDrawPaint.setColor(Color.WHITE);
                                    }
        ...
        public void calcWidthHeight() {
            ...
            cellWidth = (mWidth - mCalendarPaddingLeft - mCalendarPaddingRight) / mDaysPerWeek;
            cellHeight = (mHeight - mCalendarPaddingTop - mCalendarPaddingBottom) / mNumRows;
        }
    ...
    public void setOnDatePickerChangeListener(OnDatePickerChangeListener onDatePickerChange) {
        this.mOnDatePickChangeListener = onDatePickerChange;
    }
