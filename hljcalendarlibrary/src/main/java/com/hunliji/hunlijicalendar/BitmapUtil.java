...
/**
 * Created by luohanlin on 2018/3/23.
 */
...
public class BitmapUtil {
    ...
    public static Bitmap crop(
        ...
        if (horizontalCenterPercent < 0 || horizontalCenterPercent > 1 || verticalCenterPercent <
                0 || verticalCenterPercent > 1) {
        ...
        final Bitmap cropped = Bitmap.createBitmap(src,
                srcX,
                srcY,
                srcCroppedW,
                srcCroppedH,
