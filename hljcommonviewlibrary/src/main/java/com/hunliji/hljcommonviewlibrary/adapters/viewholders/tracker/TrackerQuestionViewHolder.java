...
public abstract class TrackerQuestionViewHolder extends BaseViewHolder<Question> {

    public TrackerQuestionViewHolder(View itemView) {
        super(itemView);
    }

    @Override
    public void setView(Context mContext, Question item, int position, int viewType) {
        try {
