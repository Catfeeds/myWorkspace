...
public class RoundedImageView extends ImageView {
    ...
    public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        disRounded = a.getInteger(R.styleable.RoundedImageView_round_disabled, 0);
    ...
    public void setScaleType(ScaleType scaleType) {
        ...
        if (mScaleType != scaleType) {
            ...
            if (mDrawable instanceof RoundedDrawable && ((RoundedDrawable) mDrawable)
                    .getScaleType() != scaleType) {
                ((RoundedDrawable) mDrawable).setScaleType(scaleType);
            }

            if (mBackgroundDrawable instanceof RoundedDrawable && ((RoundedDrawable)
                    mBackgroundDrawable).getScaleType() != scaleType) {
    ...
    public void setBorderColors(ColorStateList colors) {
        ...
        mBorderColor = colors != null ? colors : ColorStateList.valueOf(RoundedDrawable
